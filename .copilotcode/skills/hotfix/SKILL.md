...
> **Explicit invocation only**: This skill should only run when the user explicitly requests it with `使用 hotfix 技能`. Do not auto-invoke based on context matching.
...
6b. **Collect approvals** — Use the `new_task` tool to request sign-off:
