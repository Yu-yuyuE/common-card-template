...
**Format**: `使用 reverse-document 技能 <type> <path>`
...
**Examples**:
```bash
使用 reverse-document 技能 design src/gameplay/magic-system
使用 reverse-document 技能 architecture src/core/entity-component
使用 reverse-document 技能 concept prototypes/vehicle-combat
```
...
1. Run 使用 balance-check 技能 on combat formulas (exponential scaling concern)
...
```
User: 使用 reverse-document 技能 design src/gameplay/combat
...
Agent: ✅ Written to design/gdd/combat-system.md
       ...
       - Run 使用 balance-check 技能 to validate progression curve
