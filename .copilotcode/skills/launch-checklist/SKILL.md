...
> **Explicit invocation only**: This skill should only run when the user explicitly requests it with `使用 launch-checklist 技能`. Do not auto-invoke based on context matching.
...
2. **Gather project context**:
   - Read `COPILOT.md` for tech stack, target platforms, and team structure
...
5. **Save the checklist** to
   `production/releases/[date].md`, creating directories as needed.
