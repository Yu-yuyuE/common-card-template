...
**Decision Points:** At each phase transition, use `ask_followup_question` to present
...
- Generate the release checklist using `使用 release-checklist 技能`
...
- Generate changelog using `使用 changelog 技能`
