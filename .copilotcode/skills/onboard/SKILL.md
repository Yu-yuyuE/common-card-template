...
1. **Read the COPILOT.md** for project overview and standards.

2. **Read the relevant agent definition** from `.copilotcode/agents/` if a specific
   role is specified.
...
[Summary of conventions relevant to this role from COPILOT.md and agent definition]
